<div class="wsus__chat_info">
    ...
    <div class="wsus__chat_info_details">
        <div class="user_photo">
            <img src="{{ asset('assets/images/jaymeg.jpg') }}" alt="User" class="img-fluid">
        </div>
        <h3 class="user_name">Jaymeg</h3>
        ...
        <ul class="wsus__chat_info_gallery">
            <li>
                <a class="venobox" data-gall="gallery01" href="{{ asset('assets/images/jaymeg.png') }}">
                    <img src="{{ asset('assets/images/jaymeg.png') }}" alt="gallery1" class="img-fluid w-100">
                </a>
            </li>
        </ul>
    </div>
